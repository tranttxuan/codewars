...
function firstNSmallest(array, n) {
    const valueIndexPairs = [...array].map((x, i) => { return { value: x, index: i } });
    const sortArray = valueIndexPairs.sort((a, b) => a.value - b.value || a.index - b.index);
    let result = sortArray.slice(0, n);
    return orderResult = result.sort((a, b) => a.index - b.index).map(x => { return x.value });

}

console.log(firstNSmallest([7, -6, 5, 6, 2, 3, 0, -9, -3, -9, 8, 10, -6, -3, -6, -9, -6, 10, 5, -5, 0, 10, 5, -9], 7))
